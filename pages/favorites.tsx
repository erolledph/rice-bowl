...
import { Heart, UtensilsCrossed, Search } from 'lucide-react'
			...
			<Section>
				...
				{loading ? (
					...
					<div className='text-center py-20'>
						<UtensilsCrossed className='w-16 h-16 text-orange-600 mx-auto mb-4' />
						...
						<p className='text-zinc-500 dark:text-zinc-500 mb-8'>
							Explore recipes and mark them with <Heart className='inline w-4 h-4 text-orange-600 fill-orange-600' /> to add them to your favorites
						</p>
							<Link
								href='/recipes'
