...
const links = [
	...
	},
	{
		...
		icon: (
			...
			>
				<path
					d='M7.5 12.5l-1.06-.94C4.23 10.28 2 8.22 2 5.5 2 3.46 3.46 2 5.5 2c.91 0 1.79.34 2.5.95.71-.61 1.59-.95 2.5-.95C11.54 2 13 3.46 13 5.5c0 2.72-2.23 4.78-4.44 6.06L7.5 12.5z'
					fill='currentColor'
				/>
			</svg>
		),
