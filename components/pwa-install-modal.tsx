						...
						<div>
							...
							<ul className='mt-2 text-sm space-y-1 text-slate-700 dark:text-slate-200'>
								<li className='flex items-center gap-2'>
									<Check className='w-5 h-5 text-blue-500' /> Offline access
								</li>
								<li className='flex items-center gap-2'>
									<Check className='w-5 h-5 text-blue-500' /> Fast loading
								</li>
								<li className='flex items-center gap-2'>
									<Check className='w-5 h-5 text-blue-500' /> Home screen icon
								</li>
							</ul>
						</div>
					</div>
